  ...
  return (
    <div className=" max-w-[1240px ]  mx-auto py-16 px-4 text-center">
      ...
      <div className=" grid grid-rows-none  md:grid-cols-5  py-4 gap-2  md:gap-4 ">
        ...
        <div className='bg-gray-900/30 absolute top-0 left-0 w-full h-full' >
          <p className="left-3 bottom-3 text-2xl font-bold text-white absolute"> Manali</p>
        </div>
        </div>
        <div className="relative">
        <img className="w-full h-full object- cover" src={Pic2} alt="/" />
        <div className='bg-gray-900/30 absolute top-0 left-0 w-full h-full' >
          <p className="left-3 bottom-3 text-2xl font-bold text-white absolute"> Dharamshala</p>
        </div>
        </div>
        ...
        <div className='bg-gray-900/30 absolute top-0 left-0 w-full h-full' >
          <p className="left-3 bottom-3 text-2xl font-bold text-white absolute"> Bir Billing</p>
        </div>
        </div>
      </div>
    </div>
